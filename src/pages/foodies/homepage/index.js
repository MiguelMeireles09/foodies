...
export default function Home() {
  ...
  return (
    <div className="py-6 min-h-screen px-4 md:px-14 lg:px-20 xl:px-28 ">
      ...
      <div className='flex flex-wrap justify-around pb-4'>
        ...
        <Card imagem="/images/ReceitasBaratas.png" nomeComida="Receitas Económicas" href="/foodies/homepage/maisBaratas" />
